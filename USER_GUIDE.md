...
3. Pick how you want to answer using the two buttons at the top of the response box:
   ...
   - **Anonymous** — the answer is stored without any link to you. Even the admin cannot trace it back. You **cannot edit or delete** it once submitted, and it disappears from your view as soon as you reload the page.
...
(Anonymous answers can't be edited or deleted — that's intentional.)
...
- Your **anonymous responses** are visible to admins only, with no attribution. Once submitted, even you cannot find them again.
